...
<div>
    ...
    <div>
        <form action="../MainPageServlet" method="POST">
        <input type="hidden" name="command" value="SIGNUP_BY_PHONE">
            <div id="left">
                
                <input class="button2" type="text" name="username" placeholder="Tên tài khoản">
                <br></br>
                ...
                <input class="button2" type="text" name="number-phone" placeholder="Nhập số điện thoại của bạn">
                <br></br>
            ...
            <div id=right>
                ...
                <br></br>
                GIỚI TÍNH:
                <input type="radio"  name="gender" value="boy">NAM
                ...
                <a href="sign-up-email-form.jsp"><input class="button5" type="button" value="Đăng kí bằng Email"></a>
            </div>
        </form>
