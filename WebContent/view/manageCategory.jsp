    ...
    <div id="content">
        <table border="1" cellpadding="5">
        	...
        	<c:forEach var="tempImage" items="${list_image }">
        		...
        		<c:url var="tempLink" value="manage_Category_Action_Servlet">
        		...
        		<c:url var="deleteProduct" value="manage_Category_Action_Servlet">
        				...
        				<div id="modalOne" class="modal">
					      <div class="modal-content">
					        <div class="contact-form">
					          ...
					          <form action="manage_Category_Action_Servlet" method="post">
