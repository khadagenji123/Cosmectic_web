...
<div id="menu">
	<a href="MainPageServlet"><input class="button1" type="button" value="TRANG CHỦ"></a>
	<a href="Best_Selling_Servlet"><input class="button1" type="button" value="BÁN CHẠY"></a>
	<a href="new_Products_Servlet"><input class="button1" type="button" value="HÀNG MỚI VỀ"></a>
	<form>
...
<div id="show-image">
	<c:forEach var="tempImage" items="${list_image}">
		<c:url var="tempLink" value="detail_Servlet">
	 		<c:param name="command" value="product-index"/>
