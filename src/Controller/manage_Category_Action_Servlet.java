...
import DAO.manage_Category_Action_DAO;
import DAO.manage_TradeMark_Action_DAO;
import model.Image;

/**
 * Servlet implementation class manage_Category_Action_Servlet
 */
@WebServlet("/manage_Category_Action_Servlet")
public class manage_Category_Action_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	@Resource(name="jdbc/cosmetic_web")
	private DataSource dataSource;
	private manage_Category_Action_DAO manage;
	...
	public void init(ServletConfig config) throws ServletException {
    	...
    	manage = new manage_Category_Action_DAO(jdbcURL, jdbcUsername, jdbcPassword);
    }
	...
	private void loadProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/view/update-category-form.jsp");
	...
	private void deleteProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String url = "manage_Category_Servlet?value="+category;
	...
	private void addProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String url = "http://localhost:8081/Cosmetic-web/manage_Category_Servlet?value=" +category;
		response.sendRedirect(url);
	}
