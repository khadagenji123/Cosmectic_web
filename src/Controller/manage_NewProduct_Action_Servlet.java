...
import DAO.manage_NewProduct_Action_DAO;
import model.Image;

/**
 * Servlet implementation class manage_NewProduct_Action_Servlet
 */
@WebServlet("/manage_NewProduct_Action_Servlet")
public class manage_NewProduct_Action_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
     
	@Resource(name="jdbc/cosmetic_web")
	private DataSource dataSource;
	private manage_NewProduct_Action_DAO manage;
    /**
	...
	public void init(ServletConfig config) throws ServletException {
    	...
    	manage = new manage_NewProduct_Action_DAO(jdbcURL, jdbcUsername, jdbcPassword);
    }
	...
	private void loadProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/view/update-newproduct-form.jsp");
	...
	private void deleteProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String url = "manage_NewProduct_Servlet";
	...
	private void addProduct(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String url = "http://localhost:8081/Cosmetic-web/manage_NewProduct_Servlet";
		response.sendRedirect(url);
	}
